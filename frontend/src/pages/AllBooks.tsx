...
const AllBooks = () => {
  ...
  if (isError) {
    return <p className="text-center mt-50 text-3xl font-bold">Failed to load tasks.</p>;
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 min-h-screen">
      <div className="flex justify-between">
        <h1 className="text-2xl font-bold text-green-600">All Books</h1>
        <Link to='/create-book' className="md:text-xl sm:text-lg font-bold text-white mb-6 bg-amber-600 px-4 py-2 rounded-lg hover:bg-amber-700 duration-300">Add New Book</Link>
      </div>
